...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-950 text-neutral-200 font-[Inter,sans-serif] px-5 sm:px-4">
      ...
      <p className="text-[48px] sm:text-[64px] font-semibold text-white leading-none tracking-tight">404</p>
      <h1 className="mt-3 text-lg sm:text-xl font-medium text-white">This page doesn&apos;t exist</h1>
